...
const output = arr.map(_function_) // this function tells map that what transformation I want on each element of array
...
// Get array of full name : ["Alak sen", "Sakib rahman", ...]
const fullNameArr = users.map((user) => user.firstName + " " + user.lastName);
console.log(fullNameArr); // ["Alak sen", "Sakib rahman", ...]
...
const users = [
  { firstName: "Alak", lastName: "S", age: 23 },
  { firstName: "Sakib", lastName: "R", age: 29 },
  { firstName: "Shafin", lastName: "Ahmed", age: 29 },
...
console.log(output); // ["Alak", "Sakib", "Shafin"]
...
Function chaining, also known as method chaining, is a programming technique used in object-oriented languages, including JavaScript, to invoke multiple methods or functions on an object in a single statement. The result of each method call is typically the object itself, allowing for consecutive method calls to be chained together.
